...
var Engine = (function(global) {
    ...
    //game over message
    else if (curGameState == gameStates[1]) {
        ...
        var zeroLifeMessage = 'Game Over :(' + '<br>';
        var gameScoreMessage = 'Your final score is ' + score;
    ...
    function init() {
        ...
        doc.getElementById('start').onclick = function() {
            ...
            doc.getElementById('lives').innerHTML = '💚 Lives: ' + lives;
            doc.getElementById('lives').style.display = 'inline';
            doc.getElementById('score').innerHTML = '|| 🚀 Score: ' + score;
            doc.getElementById('score').style.display = 'inline';
